...
#define SUBTARGET_ATTRIBUTES                                            \
  { "asmreg",      1, 1, false,  true, false, \
       true, amigaos_handle_type_attribute, NULL}, \
  { "asmregs",     1, 1, false,  true,  true, \
       true, NULL, NULL }, \
  { "chip",        0, 0, false,  true, false, \
      false, amigaos_handle_type_attribute, NULL }, \
  { "fast",        0, 0, false,  true, false, \
      false, amigaos_handle_type_attribute, NULL }, \
  { "far",         0, 0, false,  true, false, \
      false, amigaos_handle_type_attribute, NULL }, \
  { "saveds",      0, 0, false,  true,  true, \
      false, amigaos_handle_type_attribute, NULL }, \
  { "entrypoint",  0, 0, false,  true,  true, \
      false, amigaos_handle_type_attribute, NULL }, \
  { "saveallregs", 0, 0, false,  true,  true, \
      false, amigaos_handle_type_attribute, NULL }, \
  { "regparm",     1, 1, false,  true,  true, \
       true, amigaos_handle_type_attribute, NULL }, \
  { "stkparm",     0, 0, false,  true,  true, \
       true, amigaos_handle_type_attribute, NULL },
