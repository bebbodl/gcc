...
(define_insn "*addsi3_internal"
  [(set (match_operand:SI 0 "nonimmediate_operand" "=m,d,a,a,?a,?a")
        (plus:SI (match_operand:SI 1 "general_operand" "%0,0,0,a,a,rJK")
                 (match_operand:SI 2 "general_src_operand" "dIKLT,mSrIKLT,mSrIKLs,u,rJK,a")))]
  "! TARGET_COLDFIRE"
  "* return output_addsi3 (operands);")

(define_insn "*addsi3_internal_addr"
  [(parallel
    [(set (match_operand:SI 0 "register_operand" "=a,a,a")
        (plus:SI (match_operand:SI 1 "general_src_operand" "a,a,rJK")
                 (match_operand:SI 2 "general_src_operand" "u,rJK,a")))
     (const_int 0)])]
  "! TARGET_COLDFIRE"
  "* return output_addsi3 (operands);")
...
(define_insn "*lea"
  [(set (match_operand:SI 0 "nonimmediate_operand" "=a")
	(match_operand:QI 1 "address_operand" "pu"))]
  ""
  "lea %a1,%0")

...
(define_peephole2
  [(set (match_operand:SI 0 "register_operand")
   ...
   (set (pc)
        (match_operand:SI 2 "register_operand"))]
  "DOUBLE_INDIRECT_JUMP && TARGET_68020 && operands[0] == operands[2]"
  [(set (pc) (match_dup 1))]
  ""
)
...
(define_insn "double_indirect_jump"
  ...
  "TARGET_68020 && DOUBLE_INDIRECT_JUMP"
  "jmp %a0"
  [(set_attr "type" "jmp")])
...
;; transform into a "lea" only instruction
(define_peephole2
  [(set (match_operand:SI 0 "register_operand" "")
        (plus:SI (match_operand:SI 1 "general_src_operand" "")
                 (match_operand:SI 2 "general_src_operand" "")))]
  "REG_P(operands[0]) && 
   ((REG_P(operands[1])
     ...
     && GET_CODE(operands[2]) == CONST && 
  	(GET_CODE(XEXP(operands[2], 0)) == UNSPEC ||
  	 (GET_CODE(XEXP(operands[2], 0)) == PLUS && GET_CODE(XEXP(XEXP(operands[2], 0), 0)) == UNSPEC)))
   ||
    (REG_P(operands[2])
     && REGNO(operands[0]) != REGNO(operands[2]) 
     && GET_CODE(operands[1]) == CONST && 
  	(GET_CODE(XEXP(operands[1], 0)) == UNSPEC ||
  	 (GET_CODE(XEXP(operands[1], 0)) == PLUS && GET_CODE(XEXP(XEXP(operands[1], 0), 0)) == UNSPEC))))  	 
  "
  [(parallel [
      (set (match_dup 0)
...
(define_expand "<monads><mode>2"
  ...
  "TARGET_68881 && flag_unsafe_math_optimizations && ((!TARGET_68060 && !TARGET_68040) || TARGET_AMIGAOS)"
  {
    extern rtx singbas;
	extern rtx doubbas;
