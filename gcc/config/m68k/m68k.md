...
(define_insn "*extv_bfexts_mem1"
  [(set (match_operand:SI 0 "register_operand" "=d")
	(sign_extract:SI (match_operand:HI 1 "memory_operand" "o")
			 (match_operand:SI 2 "nonmemory_operand" "dn")
			 (match_operand:SI 3 "nonmemory_operand" "dn")))]
  "TARGET_68020 && TARGET_BITFIELD"
  "bfexts %1{%b3:%b2},%0")
...
(define_insn "*extzv_bfextu_mem1"
  [(set (match_operand:SI 0 "register_operand" "=d")
	(zero_extract:SI (match_operand:HI 1 "memory_operand" "o")
			 (match_operand:SI 2 "nonmemory_operand" "dn")
			 (match_operand:SI 3 "nonmemory_operand" "dn")))]
  "TARGET_68020 && TARGET_BITFIELD"
{
...
(define_insn "*tst_bftst_mem1"
  [(set (cc0)
	(compare (zero_extract:SI (match_operand:HI 0 "memory_operand" "o")
				  (match_operand:SI 1 "const_int_operand" "n")
				  (match_operand:SI 2 "general_operand" "dn"))
	         (const_int 0)))]
  "TARGET_68020 && TARGET_BITFIELD"
...
(define_peephole2
  [(set (match_operand:SI 0 "register_operand")
   ...
   (set (pc)
        (match_operand:SI 2 "register_operand"))]
  "TARGET_68020 && operands[0] == operands[2]"
  [(set (pc) (match_dup 1))]
  ""
)

;; and the insn for double indirect jumps  
(define_insn "double_indirect_jump"
...
;; move d3,d0
;; 
;; it's likely that d0 is just a temp register
;; if d0 is not used elsewhere the assignment is optimized away in bbb-opts.c
;;
;; in_struct is not used with registers, we use it as a marker here
(define_peephole2
  [(set (match_operand 0 "register_operand")
        (match_operand 1 "general_src_operand"))
   (set (match_operand 2 "register_operand")
        (match_operand 3 "register_operand"))]
   "operands[0] == operands[3] && !operands[0]->in_struct
 && (REGNO(operands[2]) < 8 || GET_MODE_SIZE(GET_MODE(operands[0])) > 1) /* no QI into ax */"
  [(set (match_dup 2) (match_dup 1))
   (set (match_dup 0) (match_dup 2))]
  "{ operands[2]->in_struct = 1; }"
)
...
(define_peephole2
  [(set (match_operand:SI 0 "register_operand")
   ...
   "operands[0] != operands[5] && INTVAL(operands[2]) == 1 && INTVAL(operands[2]) == -INTVAL(operands[4])
...
(define_peephole2
  [(set (match_operand:SI 0 "register_operand")
   ...
   "operands[0] != operands[5] && INTVAL(operands[2]) == 2 && INTVAL(operands[2]) == -INTVAL(operands[4])
...
(define_peephole2
  [(set (match_operand:SI 0 "register_operand")
   ...
   "operands[0] != operands[5] && INTVAL(operands[2]) == 4 && INTVAL(operands[2]) == -INTVAL(operands[4])
